...
export const DockIcons = {
  ...
  wall: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    <defs><linearGradient id="wlb" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#34C759"/><stop offset="1" stop-color="#1FA547"/></linearGradient></defs>
    <rect x="2" y="2" width="60" height="60" rx="14" fill="url(#wlb)"/>
    <path d="M14 18 a6 6 0 0 1 6 -6 h24 a6 6 0 0 1 6 6 v18 a6 6 0 0 1 -6 6 h-19 l-8 8 v-8 h-3 a6 6 0 0 1 -6 -6 z" fill="#fff"/>
    <line x1="21" y1="21" x2="43" y2="21" stroke="#34C759" stroke-width="2.6" stroke-linecap="round"/>
    <line x1="21" y1="28" x2="43" y2="28" stroke="#34C759" stroke-width="2.6" stroke-linecap="round"/>
    <line x1="21" y1="35" x2="34" y2="35" stroke="#9FDFB4" stroke-width="2.6" stroke-linecap="round"/>
  </svg>`,
