...
const MODES = new Set(['normal', 'low_power', 'ai_gateway']);
export function normalizeModelMode(mode) {
  return MODES.has(mode) ? mode : 'normal';
}

export function resolveModelRoute({ mode, normalModel, lowPowerModel = 'openrouter/free', aiModel = 'gpt-5.3-codex-spark' }) {
